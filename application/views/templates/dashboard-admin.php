  ...
  <div class="wrapper">
          ...
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="user-header bg-primary">
              ...
              <p>
                ...
                <small><?= $this->session->userdata('user_access'); ?></small>
              </p>
            </li>
            <!-- Menu Body -->
            <li class="user-body">
            ...
            <li class="user-footer">
              <a href="<?= base_url('auth/logout'); ?>" class="btn btn-default btn-flat float-right"><?= $this->lang->line('text-logout'); ?></a>
            </li>
          </ul>
        </li>
      </ul>
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4 sidebar-no-expand">
      ...
      <a href="<?= base_url('admin'); ?>" class="brand-link bg-light">
        ...
        <span class="brand-text">Nagoya Plasa Hotel</span>
      </a>
        ...
        <div class="user-panel mt-1 pb-2 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">
              <span style="font-size: 16px;"><?= $this->session->userdata('user_fullname'); ?></span>
              <br>
              <small><?= $this->session->userdata('user_access'); ?></small>
            </a>
          </div>
