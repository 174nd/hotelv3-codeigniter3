...
<div class="modal fade" id="rooms-data">
...
<div class="modal fade" id="reservation-fill">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="add-guests">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="add-additional_costs_fill">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="reservation-data">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
      ...
      <div class="modal-body">
        <ul class="list-group list-group-unbordered">
            ...
            <div class="row">
              <div class="col-md-3 mb-2">
                <select id="column_reservation_data" class="form-control custom-select">
                  ...
                  <option value="2"><?= $this->lang->line('text-in_house') ?></option>
          ...
          <li class="list-group-item">
            <div class="table-responsive">
              <table id="table_reservation_data" class="table table-bordered table-hover" style="min-width: 300px; width:100%;">
                <thead>
                  <tr>
...
<div class="modal fade" id="reservation-detail">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="checkin-reservation">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="add-additional_costs_data">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="delete-additional_costs_data">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<!-- /.Modul - Check-In Data -->
<div class="modal fade" id="checkin-data">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
      ...
      <div class="modal-body">
        <ul class="list-group list-group-unbordered">
          ...
          <li class="list-group-item">
            <div class="table-responsive">
              <table id="table_checkin_data" class="table table-bordered table-hover" style="min-width: 300px; width:100%;">
                <thead>
                  <tr>
                    <th><?= $this->lang->line('text-reservation_number') ?></th>
                    <th><?= $this->lang->line('text-guests') ?></th>
...
<div class="modal fade" id="checkin-detail">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="checkout-reservation">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="change-rooms">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="check-rooms-change">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="extend-days">
...
<div class="modal fade" id="check-extend-days">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="delete-payment">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title"><?= $this->lang->line('text-delete_payment') ?> xxx</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <h4 class="modal-title"><?= $this->lang->line('modal-delete_payment'); ?></h4>
      </div>
      <div class="modal-footer">
        <div class="btn-group btn-block">
          <input type="hidden" id="payment_history_id">
          <input type="hidden" id="reservation_id">
          <button class="btn btn-outline-success" data-dismiss="modal"><?= $this->lang->line('text-cancel'); ?></button>
          <button class="btn btn-outline-danger" id="save"><?= $this->lang->line('text-save'); ?></button>
        </div>
...
<div class="modal fade" id="change-price">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
      ...
      <div class="modal-header">
        <h4 class="modal-title"><?= $this->lang->line('text-change_price') ?></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
          ...
          <li class="list-group-item">
            <div class="table-responsive">
              <table class="table table-bordered" style="margin: 0; min-width: 700px; width:100%;">
                <thead>
                  <tr>
                    <th><?= $this->lang->line('text-reservation_description') ?></th>
                    <th class='text-center' style="width: 150px;"><?= $this->lang->line('text-price') ?></th>
                    <th class='text-center' style="width: 90px;"><?= $this->lang->line('text-qty') ?></th>
                    <th class='text-center' style="width: 150px;"><?= $this->lang->line('text-total') ?></th>
                  </tr>
                ...
                <tbody>
                  <tr>
                    <td class='align-middle' id="room_name" rowspan="2"></td>
                    <td class='text-center align-middle' id="room_price"></td>
                    <td class='text-center align-middle' id="in_house" rowspan="2"></td>
                    <td class='text-center align-middle' id="total_price"></td>
                  </tr>
                  <tr>
                    <td class='text-center align-middle'>
                      <div class="input-group input-group-sm">
                        <div class="input-group-append"><span class="input-group-text">Rp.</span></div>
                        <input type="text" class="form-control money_format text-right room_price" placeholder="<?= $this->lang->line('field-room_price') ?>">
                      </div>
                    </td>
                    <td class='text-center align-middle' id="total_change"></td>
                  </tr>
                  <tr>
                    <td></td>
                    <td class='text-center align-middle' id="price_difference"></td>
                    <td></td>
                    <td class='text-center align-middle' id="total_difference"></td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="modal-footer">
        <div class="btn-group btn-block">
          <input type="hidden" id="room_reservation_id">
          <button class="btn btn-danger" data-dismiss="modal"><?= $this->lang->line('text-cancel'); ?></button>
          <button type="button" id="save" class="btn btn-primary"><?= $this->lang->line('text-save'); ?></button>
        </div>
      </div>
...
<div class="modal fade" id="add-additional_costs_checkin">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="delete-additional_costs_checkin">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="guest-data">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
      ...
      <div class="modal-body">
        <ul class="list-group list-group-unbordered">
          ...
          <li class="list-group-item">
            <div class="table-responsive">
              <table id="table_guest_data" class="table table-bordered table-hover" style="min-width: 300px; width:100%;">
                <thead>
                  <tr>
                    <th><?= $this->lang->line('text-reservation_number') ?></th>
                    <th><?= $this->lang->line('text-guests') ?></th>
...
<div class="modal fade" id="guest-detail">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
