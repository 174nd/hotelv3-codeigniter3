...
<body>
  ...
  <table class="description-table">
    <tr>
      ...
      <th><?= $this->lang->line('text-bill_number') ?></th>
      <td>:</td>
  ...
  <table class="folio-table">
    <thead>
      <tr>
        ...
        <th class='text-center'><?= $this->lang->line('text-date') ?></th>
      ...
      foreach ($room_data['rooms'] as $r1) {
        foreach ($r1['room_data'] as $r2) {
          ...
          <tr>
            ...
            <td rowspan="<?= $r2['row_number'] ?>" class="align-middle text-center"><?= moneyFormat($total); ?></td>
          </tr>
