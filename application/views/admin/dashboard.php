<div class="container-fluid">
  ...
  <div class="row">
    ...
    <section class="col-md-4 connectedSortable" id="report">
      ...
      <form class="card card-warning collapsed-card" method="POST" action="<?= base_url('export/daily_shift_report') ?>">
        <div class="card-header">
      ...
      <form class="card card-teal collapsed-card" method="POST" action="<?= base_url('export/housekeeping_room_change_report') ?>">
        <div class="overlay d-flex justify-content-center align-items-center invisible">
          <i class="fas fa-2x fa-sync fa-spin"></i>
        </div>
        <div class="card-header">
          <h3 class="card-title"><?= $this->lang->line('text-housekeeping_room_change_report'); ?></h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse">
              <i class="fas fa-plus"></i>
            </button>
        ...
        <div class="card-body">
          <ul class="list-group list-group-unbordered">
            ...
            <li class="list-group-item">
              <button type="submit" id="check_guest" class="btn btn-block btn-light bg-teal"><?= $this->lang->line('text-find_data'); ?></button>
            </li>
          </ul>
        </div>
        <!-- /.card-body -->
...
<div class="modal fade" id="delete-payment" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
...
<div class="modal fade" id="change-price" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="overlay d-flex justify-content-center align-items-center invisible">
        <i class="fas fa-2x fa-sync fa-spin"></i>
